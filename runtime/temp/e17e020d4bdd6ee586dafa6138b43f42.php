<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\app_mt\public/../application/common\view\tpl\dispatch_jump.tpl";i:1521100758;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="system-message <?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>">
            <div class="image">
                <img src="/assets/img/<?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo($msg);?></h1>
            <p class="jump">
