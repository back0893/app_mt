<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\app_mt\public/../application/admin\view\general\config\index.html";i:1521100758;s:52:"E:\app_mt\application\admin\view\layout\default.html";i:1521100758;s:49:"E:\app_mt\application\admin\view\common\meta.html";i:1521100758;s:51:"E:\app_mt\application\admin\view\common\script.html";i:1521100758;}*/ ?>
<!DOCTYPE html>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-sm-8 col-xs-12">
                                                ...
                                                <textarea name="row[<?php echo $item['name']; ?>]" class="form-control editor" data-rule="<?php echo $item['rule']; ?>" rows="5" data-tip="<?php echo $item['tip']; ?>" <?php echo $item['extend']; ?>><?php echo $item['value']; ?></textarea>
                                                <?php break; case "array": ?>
                                                <dl class="fieldlist" rel="<?php echo count($item['value']); ?>" data-name="row[<?php echo $item['name']; ?>]">
                                                    <dd>
                                                        <ins><?php echo __('Array key'); ?></ins>
                                                        <ins><?php echo __('Array value'); ?></ins>
                                                    </dd>
                                                    <?php foreach($item['value'] as $key => $vo): ?>
                                                ...
                                                <select name="row[<?php echo $item['name']; ?>]<?php echo $item['type']=='selects'?'[]':''; ?>" class="form-control selectpicker" data-tip="<?php echo $item['tip']; ?>" <?php echo $item['type']=='selects'?'multiple':''; ?>>
